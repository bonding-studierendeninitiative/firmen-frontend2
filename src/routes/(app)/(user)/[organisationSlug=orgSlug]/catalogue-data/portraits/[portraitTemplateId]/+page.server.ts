...
import {
	getPortraitTemplate,
	PortraitCompanyDetailsSchema, PortraitContactInfoSchema, updatePortraitDetails
} from '$lib/services/portraitTemplates';
...
export const load: PageServerLoad = async ({ params, parent }) => {
	...
	const updatePortraitCompanyDetailsForm = await superValidate(portraitTemplate, valibot(PortraitCompanyDetailsSchema));
	const updatePortraitContactInfoForm = await superValidate(portraitTemplate, valibot(PortraitContactInfoSchema));
...
export const actions = {
	...
	updatePortraitCompanyDetails: async ({ request, locals, params }) => {
		...
		const updatePortraitCompanyDetailsForm = await superValidate(request, valibot(PortraitCompanyDetailsSchema));
	...
	updatePortraitContactInfo: async ({ request, locals, params }) => {
		...
		const updatePortraitContactInfoForm = await superValidate(request, valibot(PortraitContactInfoSchema));
