...
export type CreateAddonPackageTemplateRequest = v.InferInput<typeof CreateAddonPackageTemplateSchema>;
export type CreateAddonPackageTemplateResponse = v.InferInput<typeof CreateAddonPackageTemplateResponseSchema>;
...
export type GetAddonPackageTemplateResponse = v.InferInput<typeof GetAddonPackageTemplateResponseSchema>;

export const GetAddonPackageTemplatesResponseSchema = v.object({
	'addonPackageTemplates': v.array(
		AddonPackageTemplateSchema
	),
...
export type GetAddonPackageTemplatesResponse = v.InferInput<typeof GetAddonPackageTemplatesResponseSchema>;