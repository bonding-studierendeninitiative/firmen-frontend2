...
<form action="?/updateBuyOption" method="post" use:enhance>
										...
										<Control let:attrs>
											...
											<DropdownMenu.Root>
												...
												<DropdownMenu.Content>
													...
													>
														<DropdownMenu.RadioItem value="STRING">Text</DropdownMenu.RadioItem>
														<DropdownMenu.RadioItem value="BOOLEAN"
															>Enthalten
														</DropdownMenu.RadioItem>
														<DropdownMenu.RadioItem value="INTEGER">Betrag</DropdownMenu.RadioItem>
													</DropdownMenu.RadioGroup>
												</DropdownMenu.Content>
											</DropdownMenu.Root>
										</Control>
