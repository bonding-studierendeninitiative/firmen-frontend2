<script lang="ts">
	...
	import { Button, GradientButton, InputWithPrefix, Textarea } from '$lib/@svelte/components';
	...
	<section class=" w-full mt-10">
		...
		<div class="grid grid-cols-1 sm:grid-cols-4 gap-4 py-6 border-b-1 border-slate-200">
			...
			<div class="col-span-3">
				<Textarea name="contactPersonStudents" bind:value={$form.contactPersonStudents} {...$constraints.contactPersonStudents}
		...
		<div class="grid grid-cols-1 sm:grid-cols-4 gap-4 py-6 border-b-1 border-slate-200">
			...
			<div class="col-span-3">
				<Textarea name="contactPersonGraduates" bind:value={$form.contactPersonGraduates} {...$constraints.contactPersonGraduates}
		...
		<div class="grid grid-cols-1 sm:grid-cols-4 gap-4 py-6 border-b-1 border-slate-200">
			...
			<div class="col-span-3">
				<Textarea name="contactAddress" bind:value={$form.contactAddress} {...$constraints.contactAddress} placeholder={$_('user-pages.portraits.contactAddress')} />
			</div>
		</div>
